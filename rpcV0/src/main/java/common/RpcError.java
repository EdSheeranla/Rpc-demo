...
public class RpcError {
    public final static String SERVICE_NOT_IMPLEMENT_ANY_INTERFACE = "service not implement any interface";
    public final static String SERVICE_NOT_FOUND = "service not found";
